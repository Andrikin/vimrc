...
hi SpecialKey      guifg=#66D9EF               cterm=italic

hi MatchParen      guibg=#000000 guifg=#FD971F cterm=bold
...
hi SpecialComment  guifg=#7E8E91               cterm=bold
hi Special         guifg=#66D9EF guibg=bg      cterm=italic
if has("spell")
    hi SpellBad    guisp=#FF0000 cterm=undercurl
    hi SpellCap    guisp=#7070F0 cterm=undercurl
    hi SpellLocal  guisp=#70F0F0 cterm=undercurl
    hi SpellRare   guisp=#FFFFFF cterm=undercurl
endif
...
hi Type            guifg=#66D9EF               cterm=none
...
hi TabLine         guibg=#1B1D1E guifg=#808080 cterm=none

if s:molokai_original == 1
   hi Normal          guifg=#F8F8F2 guibg=#272822
   hi Comment         guifg=#75715E
   hi CursorLine                    guibg=#3E3D32
   hi CursorLineNr    guifg=#FD971F               cterm=none
   ...
   hi Comment         guifg=#7E8E91 cterm=bold,italic 
   hi CursorLine      guibg=#293739 cterm=bold 
   hi CursorLineNr    guifg=#FD971F               cterm=none
